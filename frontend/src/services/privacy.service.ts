...
export interface PrivacyRequest {
  request_uuid: string; subject_uuid: string; request_type: 'ERASURE' | 'EXPORT';
...
export async function createPrivacyRequest(payload: { subjectType: 'CLIENT'; subjectUuid: string; requestType: 'ERASURE' | 'EXPORT'; reason?: string }) {
